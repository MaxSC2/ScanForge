    ...
    return (
      <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
        <svg fill="none" height={size} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg">
          <motion.path d="M3 7V5a2 2 0 0 1 2-2h2" variants={{ visible: { opacity: 1 }, hidden: { opacity: 1 } }} />
          <motion.path d="M17 3h2a2 2 0 0 1 2 2v2" variants={{ visible: { opacity: 1 }, hidden: { opacity: 1 } }} />
          <motion.path d="M21 17v2a2 2 0 0 1-2 2h-2" variants={{ visible: { opacity: 1 }, hidden: { opacity: 1 } }} />
          <motion.path d="M7 21H5a2 2 0 0 1-2-2v-2" variants={{ visible: { opacity: 1 }, hidden: { opacity: 1 } }} />
